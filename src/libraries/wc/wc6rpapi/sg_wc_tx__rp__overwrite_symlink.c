										  ...
										  SG_wc_status_flags xu_mask)
{
	...
	// level-7 (sg_wc_tx__overwrite_...() took a pszInput which can
	...
	SG_ERR_CHECK(  sg_wc_tx__queue__overwrite_symlink(pCtx,
													  pWcTx,
													  pStringRepoPath_Src_Computed,
													  pLVI_Src,
													  pszNewTarget,
													...
													SG_wc_status_flags xu_mask)
{
	...
	SG_ERR_CHECK(  sg_wc_tx__liveview__compute_live_repo_path(pCtx, pWcTx, pLVI_Src,
															  &pStringRepoPath_Src_Computed)  );
	SG_ERR_CHECK(  sg_wc_tx__queue__overwrite_symlink_from_repo(pCtx,
																pWcTx,
																pStringRepoPath_Src_Computed,
																pLVI_Src,
																attrbits,
