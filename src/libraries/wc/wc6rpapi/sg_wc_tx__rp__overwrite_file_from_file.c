...
/**
 *
 * @file sg_wc_tx__rp__overwrite_file_from_file.c
 *
												 ...
												 SG_wc_status_flags xu_mask)
{
	...
	// level-7 (sg_wc_tx__overwrite_file_from_file() took a pszInput which can
	...
	SG_ERR_CHECK(  sg_wc_tx__queue__overwrite_file_from_file(pCtx,
															 pWcTx,
															 pStringRepoPath_Src_Computed,
															 pLVI_Src,
															 pPathTemp,
...
/**
 * Like the above, but supply the current attrbits.
 *
 */
												  ...
												  SG_wc_status_flags xu_mask)
{
	...
	// overwrite code does an in-place copy or
	// does a delete and re-create.
