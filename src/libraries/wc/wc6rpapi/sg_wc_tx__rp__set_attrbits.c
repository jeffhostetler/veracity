...
/**
 *
 * @file sg_wc_tx__rp__set_attrbits.c
 *
 * @details Layer-6 rp api to queue a chmod on an item.
 *
 */
									 ...
									 SG_wc_status_flags xu_mask)
{
	...
	// level-7 (sg_wc_tx__set_attrbits() took a pszInput which can
	...
	SG_ERR_CHECK(  sg_wc_tx__queue__set_attrbits(pCtx,
												 pWcTx,
												 pStringRepoPath_Src_Computed,
												 pLVI_Src,
												 attrbits,
