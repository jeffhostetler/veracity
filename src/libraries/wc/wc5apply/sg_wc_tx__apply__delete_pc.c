...
/**
 *
 * @file sg_wc_tx__apply__delete_pc.c
 *
 * @details 
 *
 */
...
/**
 * Delete a PC ROW from the tbl_PC table in the wc.db.
 * 
 ...
 * relative to the new baseline.  So we want the PC
 * ROW to be deleted as we transition the wc.db.
 *
 */
