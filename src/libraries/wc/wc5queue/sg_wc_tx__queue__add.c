...
/**
 *
 * @file sg_wc_tx__queue__add.c
 *
 * @details Manipulate the LVI/LVD caches to effect an ADD.
						  ...
						  sg_wc_liveview_item * pLVI)
{
	...
	SG_ERR_CHECK(  sg_wc_liveview_item__alter_structure__add(pCtx, pLVI)  );
	SG_ERR_CHECK(  sg_wc_tx__liveview__compute_live_repo_path(pCtx, pWcTx, pLVI, &pStringRepoPath)  );
	SG_ERR_CHECK(  sg_wc_tx__journal__add(pCtx, pWcTx, pLVI->pPcRow_PC, pStringRepoPath)  );
