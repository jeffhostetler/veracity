...
function st_A2653()
{
	...
	// while holding the TX open, modify the file
	// and repeat the status and see if we noticed.

	sg.file.append("f0.txt", "Hello World!\n");

	var sf1 = tx.get_item_status_flags({ "src":"@/f0.txt", "no_tsc":true });
	testlib.ok( (sf1.isNonDirModified == true), "Expect modified at sf1.");
