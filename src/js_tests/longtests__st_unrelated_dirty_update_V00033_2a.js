...
// there is ignorable dirt.  This test is intended to be exactly the same
// as __V00033_2() but with the item found rather than ignored.
//////////////////////////////////////////////////////////////////

function st_unrelated_dirty_update_V00033_2a()
{
	...
	this.do_fsobj_mkdir("dir_3/dir_foo__not_ignored");

        var expect_test = new Array;
        expect_test["Found"] = [ "@/dir_3/dir_foo__not_ignored" ];
	...
	{
	    var emsg = e.toString();
	    testlib.ok( (emsg.indexOf("The item '@/dir_3/dir_foo__not_ignored/' would become orphaned.") != -1), emsg );
	}
