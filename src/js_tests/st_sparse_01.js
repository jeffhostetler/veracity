...
function st_sparse_01() 		// was st_remove_modified_force__K8955()
{
    this.my_group = "st_sparse_01";	// this variable must match the above group name.
	...
	this.do_commit("commit remove of sparse files");
