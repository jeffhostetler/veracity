...
function st_sparse_05a()
{
	...
	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("Try to rename a sparse file...");
	...
	// TODO 2012/12/06 the STATUS embedded with UPDATE does not have a list-sparse option,
	// TODO            so we won't get them here.
	...
	// expect_test["Sparse"]                        = sparse_renamed_list;
