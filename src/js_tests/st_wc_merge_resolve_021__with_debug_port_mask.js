...
function st_wc_merge_resolve_021()
{
	...
	vscript_test_wc__write_file("PORTABILITY.%25.TXT", (content_equal + content_C1));
	vscript_test_wc__addremove();
	...
	vscript_test_wc__set_debug_port_mask2(false, true);

	vscript_test_wc__merge_np( { "rev" : csets.C } );

	var B_pathname = "@/portability.%.txt~g[0-9a-f]*";
	var C_pathname = "@/PORTABILITY.%25.TXT~g[0-9a-f]*";
	...
	vscript_test_wc__resolve__accept("other",         "@c/PORTABILITY.%25.TXT");
	vscript_test_wc__rename("@c/PORTABILITY.%25.TXT", "C__portability.txt");
