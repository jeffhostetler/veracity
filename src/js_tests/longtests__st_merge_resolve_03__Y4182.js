...
function st_merge_status()
{
	...
	//    1
        ...
        vscript_test_wc__addremove();
	vscript_test_wc__move("dir_0/dir_00", "dir_1");
	...
	sg.exec(vv, "branch", "attach", "master");
        ...
        vscript_test_wc__addremove();
	vscript_test_wc__move("dir_0/dir_00", "dir_2");
	...
	var s = sg.exec(vv, "status", "--verbose");
	...
	print("");
        ...
        expect_test["Added (Merge)"]    = [ "@/file_2",
					    "@/dir_2" ];
	expect_test["Auto-Merged"]      = [ "@/dir_1/dir_00/dir_000/dir_0000/file_0" ];
	expect_test["Modified"]         = [ "@/dir_1/dir_00/dir_000/dir_0000/file_0" ];
	expect_test["Unresolved"]                   = [ "@/dir_1/dir_00",
							"@/dir_1/dir_00/dir_000/dir_0000/file_0" ];
	expect_test["Choice Unresolved (Location)"] = [ "@/dir_1/dir_00" ];
	expect_test["Choice Unresolved (Contents)"] = [ "@/dir_1/dir_00/dir_000/dir_0000/file_0" ];
