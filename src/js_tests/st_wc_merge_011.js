...
function st_wc_merge_011()
{
    var my_group = "st_wc_merge_011";	// this variable must match the above group name.
	...
	// this dirt does not collide with anything in B or C,
	// so it should work even if the MERGE code doesn't know
	// how to do a dirty merge.

	this.do_fsobj_mkdir("dir_D");

	var expect_test = new Array;
	expect_test["Found"] = [ "@/dir_D"
			       ];
        vscript_test_wc__confirm_wii(expect_test);
