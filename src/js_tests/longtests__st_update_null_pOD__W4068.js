...
function st_update_null_pOD__W4068()
{
	...
	this.do_fsobj_mkdir("dir_1/dir_x/dir_y/dir_z/ignored_dir");
	this.do_fsobj_create_file_exactly("dir_1/dir_x/dir_y/dir_z/ignored_dir/file1.txt",
					 "Hello World!\n");
	...
	print("Confirm that everything is present.");
        ...
        expect_test["Found"] = [ "@/dir_1/dir_x",
				 ...
				 "@/dir_1/dir_x/dir_y/dir_z/ignored_dir",
				 "@/dir_1/dir_x/dir_y/dir_z/ignored_dir/file1.txt" ];
	...
	print("Confirm that .sgignores is respected.");
        ...
        expect_test["Found"] = [ "@/dir_1/dir_x",
				 "@/dir_1/dir_x/dir_y",
				 "@/dir_1/dir_x/dir_y/dir_z" ];
	expect_test["Ignored"] = [ "@/dir_1/dir_x/dir_y/dir_z/ignored_dir",
				   // "@/dir_1/dir_x/dir_y/dir_z/ignored_dir/file1.txt" // With changes for W6508
				 ];
