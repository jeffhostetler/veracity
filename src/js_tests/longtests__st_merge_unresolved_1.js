...
function st_merge_unresolved_1()
{
	...
	this.setUp = function()
	{
		...
		this.do_fsobj_append_file("dir_0_trunk/dir_00/file_000_trunk"); // edit file_000
		...
		this.do_fsobj_append_file("dir_0_branch/dir_00/file_000_branch"); // edit file_000
	...
	this.test_simple_tb_1 = function()
	{
		...
		expect_test["Modified"]      = [ "@/dir_0_trunk~g[0-9a-f]*/dir_00/file_000_trunk~g[0-9a-f]*" ];
		expect_test["Auto-Merged"]   = [ "@/dir_0_trunk~g[0-9a-f]*/dir_00/file_000_trunk~g[0-9a-f]*" ];
		...
		expect_test["Choice Unresolved (Name)"]     = [ "@/dir_0_trunk~g[0-9a-f]*/dir_00/file_000_trunk~g[0-9a-f]*",
														"@/dir_0_trunk~g[0-9a-f]*" ];
		expect_test["Choice Unresolved (Contents)"] = [ "@/dir_0_trunk~g[0-9a-f]*/dir_00/file_000_trunk~g[0-9a-f]*" ];
	...
	this.test_simple_bt_1 = function()
	{
		...
		expect_test["Modified"]      = [ "@/dir_0_branch~g[0-9a-f]*/dir_00/file_000_branch~g[0-9a-f]*" ];
		expect_test["Auto-Merged"]   = [ "@/dir_0_branch~g[0-9a-f]*/dir_00/file_000_branch~g[0-9a-f]*" ];
		...
		expect_test["Choice Unresolved (Name)"]     = [ "@/dir_0_branch~g[0-9a-f]*/dir_00/file_000_branch~g[0-9a-f]*",
														"@/dir_0_branch~g[0-9a-f]*" ];
		expect_test["Choice Unresolved (Contents)"] = [ "@/dir_0_branch~g[0-9a-f]*/dir_00/file_000_branch~g[0-9a-f]*" ];
		vscript_test_wc__confirm_wii(expect_test);
	}
