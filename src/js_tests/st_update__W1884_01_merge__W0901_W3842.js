...
function st_update__W1884_01_merge__W0901_W3842() 
{
    this.my_group = "st_update__W1884_01_merge__W0901_W3842";	// this variable must match the above group name.
	...
	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("Begin initial resolutions.");
	...
	//////////////////////////////////////////////////////////////////
	// W3842 addresses whether 'vv resolve' throws an error when --overwrite is required.

	var r = sg.exec(vv, "resolve", "accept", "other", "@c/b1/a1");
	testlib.ok( (r.exit_status != 0), "W3842: Expect error from resolve." );
	testlib.ok( (r.stderr.indexOf("Use --overwrite") >= 0), "W3842: Expect 'Use --overwrite' from resolve." );
	...
	// here "@c/" refers to X1 and "@b/" refers to X2.
	vscript_test_wc__resolve__accept("other",    "@c/b1/a1", "--overwrite");	// restore deleted item
	vscript_test_wc__resolve__accept("baseline", "@c/b2/a2", "--overwrite");	// delete kept item
	vscript_test_wc__resolve__accept("other",    "@b/b3/a3", "--overwrite");	// delete kept item
	vscript_test_wc__resolve__accept("baseline", "@b/b4/a4", "--overwrite");	// restore deleted item
	...
	expect_test["Added (Merge)"] = [ "@/b1/a1",
					 "@c/b2/a2" ];
	expect_test["Removed"]       = [ "@c/b2/a2",
					 "@b/b3/a3" ];
	expect_test["Resolved"]      = [ "@/b1/a1",
					 "@c/b2/a2",
					 "@b/b3/a3",
					 "@/b4/a4" ];
	expect_test["Choice Resolved (Existence)"]      = [ "@/b1/a1",
							    "@c/b2/a2",
							    "@b/b3/a3",
							    "@/b4/a4" ];
	vscript_test_wc__confirm_wii(expect_test);
	...
	//////////////////////////////////////////////////////////////////
	// W0901 addresses whether we can re-resovle a deleted item and get
	// it restored properly.  Let's flip-flop all of our choices back
	// to our initial choices.
	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("Begin second flip-flop on delete-vs-* resolutions.");

	// here "@c/" refers to X1 and "@b/" refers to X2.
	vscript_test_wc__resolve__accept("baseline", "@c/b1/a1", "--overwrite");	// this will delete it
	vscript_test_wc__resolve__accept("other",    "@c/b2/a2", "--overwrite");	// this will keep it (and in the X1 location)
	vscript_test_wc__resolve__accept("baseline", "@b/b3/a3", "--overwrite");	// this will keep it (and in the X2 location)
	vscript_test_wc__resolve__accept("other",    "@b/b4/a4", "--overwrite");	// this will delete it
