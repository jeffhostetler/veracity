...
function st_wc_merge_012()
{
	...
	expect_test["Added (Merge)"]                 = [ this.gid_C_C,
							 "@/dir_C~g[0-9a-f]*/dir_CC",
							 "@/dir_C~g[0-9a-f]*/dir_CC/dir_CCC",
							 "@/dir_C~g[0-9a-f]*/dir_CC/dir_CCC/dir_CCCC" ];
	expect_test["Added"]                         = [ this.gid_WC_C ];
	expect_test["Unresolved"]                    = [ this.gid_WC_C, this.gid_C_C ];
	expect_test["Choice Unresolved (Existence)"] = [ this.gid_WC_C, this.gid_C_C ];
        vscript_test_wc__confirm_wii(expect_test);
