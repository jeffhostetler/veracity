...
function st_UpdateTestsComboIssues_move_rename() 
{
	...
	vscript_test_wc__rename("dir_1/file_1", "newNameFor_file_1");
	this.do_fsobj_append_file("dir_1/newNameFor_file_1", "new line for the second version");
