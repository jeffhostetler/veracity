...
function st_wc_merge_found_02()
{
    var my_group = "st_wc_merge_found_02";	// this variable must match the above group name.
	...
	vscript_test_wc__merge_np__expect_error( { "rev" : csets.C },
						 "The item 'file_C.txt' would cause a collision" );
