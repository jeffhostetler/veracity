...
//////////////////////////////////////////////////////////////////
// Tests ADDREMVOE of already deleted item.
// For sprawl-864.
// See also R0621 and sprawl-865.
//////////////////////////////////////////////////////////////////

function st_addremove_deleted__SPRAWL_864_01()
{
	...
	print("");
	print("//////////////////////////////////////////////////////////////////");
	print("Verify that normal 'vv addremove' converts LOST to REMOVED...");
	print("");

	var result = sg.exec(vv, "addremove", "dir_A/dir_B");
	...
	testlib.ok( (result.exit_status == 0), "'vv remove dir_A/dir_B' should pass" );
        ...
        var expect_test = new Array;
	expect_test["Removed"] = [ "@b/dir_A/dir_B",
				   "@b/dir_A/dir_B/dir_C",
