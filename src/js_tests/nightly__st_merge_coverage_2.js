...
function st_merge_coverage_2()
{
	...
	vscript_test_wc__rename("dir_0_renamed/dir_00/", "dir_00_renamed");
	vscript_test_wc__rename("dir_0_renamed/dir_00_renamed/file_000", "file_000_renamed");
	...
	if ((sg.platform() == "LINUX") || (sg.platform() == "MAC"))
	{
	    expect_test["Added (Merge)"].push( "@/dir_2/dir_22/file_xxx" );
	}
        vscript_test_wc__confirm_wii(expect_test);
    }
