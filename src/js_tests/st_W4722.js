...
function st_W4722()
{
    var my_group = "st_W4722";	// this variable must match the above group name.
	...
	vscript_test_wc__write_file("file_C.txt", (content_C1));
	vscript_test_wc__addremove();
	...
	//////////////////////////////////////////////////////////////////
	// Now edit the file so that it has a different HID
	// and then COMMIT and see if the new HID gets stored.
	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("Edit file and commit.");

	vscript_test_wc__write_file("file_C.txt", (content_C1 + content_C1 + content_C1));
	csets.D = vscript_test_wc__commit("D");

	// Try a full/fresh checkout of D to see if the new blob is present.
