...
function st_revert_partial()
{
	...
	vscript_test_wc__move(   "file_2_renamed", "dir_2"  );
	this.do_fsobj_append_file("dir_2/file_2_renamed", "Hello world!\n");
	if ((sg.platform() == "LINUX") || (sg.platform() == "MAC"))
	    this.do_chmod("dir_2/file_2_renamed", 0700);
	...
	expect_test["Modified"]             = [ "@/merge_file_0.txt",
						"@/merge_edited_file_0.txt",
						"@/merge_file_0.fake_bin",
						"@/dir_2/file_2_renamed" ];
	expect_test["Moved"]                = [ "@/dir_2/file_2_renamed" ];
	expect_test["Renamed"]              = [ "@/dir_2/file_2_renamed" ];
	expect_test["Auto-Merged"]          = [ "@/merge_file_0.txt" ];
	...
	expect_test["Choice Resolved (Contents)"]      = [ "@/merge_file_0.txt",
							   ...
							   "@/merge_file_0.fake_bin" ];
	if ((sg.platform() == "LINUX") || (sg.platform() == "MAC"))
	    expect_test["Attributes"]       = [ "@/dir_2/file_2_renamed" ];
        vscript_test_wc__confirm_wii(expect_test);
	...
	vscript_test_wc__revert_items__np( { "src" : "@/dir_2/file_2_renamed",
					     "verbose" : true,
					     "revert-moved" : true } );
	...
	expect_test["Choice Resolved (Contents)"]      = [ "@/merge_file_0.txt",
							   ...
							   "@/merge_file_0.fake_bin" ];
	if ((sg.platform() == "LINUX") || (sg.platform() == "MAC"))
	    expect_test["Attributes"]       = [ "@/file_2_renamed" ];
        vscript_test_wc__confirm_wii(expect_test);
	...
	vscript_test_wc__revert_items__np( { "src" : "@/file_2_renamed",
					     "verbose" : true,
					     "revert-renamed" : true } );
	...
	vscript_test_wc__revert_items__np( { "src" : "@/file_2",
					     "verbose" : true,
					     "revert-content" : true,
					     "no_backups" : true } );
	...
	if ((sg.platform() == "LINUX") || (sg.platform() == "MAC"))
	{
	    print("");
	    print("//////////////////////////////////////////////////////////////////");
	    print("REVERT-ITEMS Partial 4...");
	    print("");

	    vscript_test_wc__revert_items__np( { "src" : "@/file_2",
						 "verbose" : true,
						 "revert-attributes" : true } );
