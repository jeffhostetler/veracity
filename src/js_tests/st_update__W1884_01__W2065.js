...
function st_update__W1884_01__W2065() 
{
    this.my_group = "st_update__W1884_01__W2065";	// this variable must match the above group name.
	...
	//
	// as for a4, it is NOT present in X1 nor X2 and in the first resolve
	// in the WD we chose to delete it too.  So it should not have an issue
	// any more -- per W2065.
	//
	// With the changes for W2065, we should have silently retired the
	// resolved issue for a3.
