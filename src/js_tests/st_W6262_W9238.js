...
function st_W6262_W3903() 
{
    this.my_group = "st_W6262_W3903";	// this variable must match the above group name.
	...
	// settling the question of "existence", this will not restore the
	// original versions of the files; it will keep the dirty working
	// versions.  
	//
	// See W6262.
