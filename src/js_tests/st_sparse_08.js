...
function st_sparse_08()
{
    this.my_group = "st_sparse_08";	// this variable must match the above group name.
	...
	var result = sg.exec(vv, "rename", "sparse_dir_1/sparse_file_1", "sparse_file_1_renamed");
	print(dumpObj(result, "sg.exec()", "", 0));
	testlib.ok( (result.exit_status == 0), "'vv rename sparse_dir_1/sparse_file_1' should work" );

        var expect_test = new Array;
	expect_test["Modified"] = [ "@/file_3" ];
	expect_test["Sparse"] = [ "@/sparse_1_renamed",
				  "@/sparse_dir_1",
				  "@/sparse_dir_1/sparse_file_1_renamed",
				  "@/sparse_dir_2",
				  "@/sparse_dir_2/sparse_file_2" ];
	expect_test["Renamed"]  = [ "@/sparse_1_renamed",
				    "@/sparse_dir_1/sparse_file_1_renamed" ];
        vscript_test_wc__confirm(expect_test,
	...
	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("Status dump after rename...");
	print(sg.to_json__pretty_print(sg.wc.status({ "list_unchanged" : true,
						      "no_ignores" : true,
						      "list_sparse" : true } )));

	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("Try to revert-all...");
