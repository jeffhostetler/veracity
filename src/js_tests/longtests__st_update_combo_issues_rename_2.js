...
function st_UpdateTestsComboIssues_rename_2() 
{
	...
	vscript_test_wc__add("file_1");
	this.do_fsobj_create_file( "file_2", "This is the first version.");
	vscript_test_wc__add("file_2");
	if ((sg.platform() == "LINUX") || (sg.platform() == "MAC"))
	{
	    this.do_chmod("file_1", 0600);
	    this.do_chmod("file_2", 0700);
	}
	this.do_commit("Combo Trunk 1.1");

	vscript_test_wc__rename("file_1", "newNameFor_file_1");
	vscript_test_wc__rename("file_2", "newNameFor_file_2");
	this.do_fsobj_append_file("newNameFor_file_1", "new line for the second version");
	this.do_fsobj_append_file("newNameFor_file_2", "new line for the second version");
	if ((sg.platform() == "LINUX") || (sg.platform() == "MAC"))
	{
	    this.do_chmod("newNameFor_file_1", 0700);
	    this.do_chmod("newNameFor_file_2", 0600);
	}
