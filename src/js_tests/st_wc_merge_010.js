...
function st_wc_merge_010()
{
    var my_group = "st_wc_merge_010";	// this variable must match the above group name.
	...
	//////////////////////////////////////////////////////////////////
	// Create some post-merge dirt in the WC and 
	// verify that it shows up in both forms of status.
	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("Create post-merge dirt.");

	// a FOUND file
	vscript_test_wc__write_file("found_1.txt", content_equal);
	// an IGNORED file
	vscript_test_wc__write_file("ignored_1.txt~sg00~", content_equal);
	// a LOST file
	sg.fs.remove("file_1");
	...
	expect_test["Found"] = [ "@/found_1.txt"
			       ];
	expect_test["Ignored"] = [ "@/ignored_1.txt~sg00~"
			      ];
	expect_test["Lost"] = [ "@/file_1"
			      ];
        vscript_test_wc__confirm(expect_test);	// don't use _wii version
	...
	vscript_test_wc__mstatus_confirm(expect_test);	// don't use _wii version
