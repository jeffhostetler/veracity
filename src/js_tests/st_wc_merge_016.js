...
function st_wc_merge_016()
{
    var my_group = "st_wc_merge_016";	// this variable must match the above group name.
	...
	expect_test["Modified (WC!=A,WC!=B,WC!=C)"] = [ "@/file.txt" ];
	expect_test["Auto-Merged"] = [ "@/file.txt" ];
	expect_test["Resolved"] = [ "@/file.txt" ];
	expect_test["Choice Resolved (Contents)"] = [ "@/file.txt" ];
