...
function st_unrelated_dirty_update_V00033()
{
	...
	this.do_fsobj_create_file("foo.c~sg00~");

        var expect_test = new Array;
        expect_test["Found"] = [ "@/foo.c~sg00~" ];
	...
	// confirm that the file is ignorable.  if the ignores
	// are set correctly in the environment, the file should
	// not appear in a plain status.

        var expect_test = new Array;
	expect_test["Ignored"] = [ "@/foo.c~sg00~" ];
