...
function st_update__W1884_01__W7720() 
{
    this.my_group = "st_update__W1884_01__W7720";	// this variable must match the above group name.
	...
	// For this test, we know that there are no conflicts between X1+dirt and Y1.
	...
	//////////////////////////////////////////////////////////////////
	// post-merge, try to resolve the conflicts from the last update.
	// TODO 2012/05/30 The use of "baseline" and "other" in this section
	// TODO            is confusing -- See W0993 -- because these issues
	// TODO            were carried-forward from the last UPDATE, they
	// TODO            actually refer to parts of the UPDATE and not the
	// TODO            parts of the MERGE we just did.
